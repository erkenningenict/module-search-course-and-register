  ...
  return (
    <Query<IMy> query={GET_MY_SIGNED_UP_PARTICIPATIONS_LIST_QUERY} fetchPolicy="network-only">
      {({ loading, data, error }) => {
        ...
        if (data.my && data.my.AangemeldeCursusDeelnames) {
          return (
            <>
              <TableResponsive>
              ...
              <PanelBody>
                ...
                <p>
                  Aanmeldingen voor digitale bijeenkomsten worden hier niet getoond. Voor afmelding
                  van een digitale bijeenkomst neemt u contact op met de organisator van de digitale
                  bijeenkomst.
                </p>
              </PanelBody>
            </>
