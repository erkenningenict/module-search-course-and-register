...
$(function() {
  ...
  $(".ly-nav-mobile-trigger").sidr({
    ...
    onOpen: function() {
      ...
      $(".ly-overlay").fadeIn(
        200
      ); /*$("#nav-main-offcanvas").height($("body").height());*/
    },
    onClose: function() {
  ...
  $(".sidr").on({
    ...
    touchmove: function(e) {
      ...
      if (
        (touchMove.pageY > touchStart.pageY && this.scrollTop == 0) ||
        (touchMove.pageY < touchStart.pageY &&
  ...
  setTimeout(function() {
    $("[data-madr1]")
      ...
      .each(function() {
        $this = $(this);
        maddr =
          $this.attr("data-madr1") +
          "@" +
          $this.attr("data-madr2") +
          "." +
          $this.attr("data-madr3");
        linktext = $this.attr("data-linktext")
          ? $this.attr("data-linktext")
          : maddr;
